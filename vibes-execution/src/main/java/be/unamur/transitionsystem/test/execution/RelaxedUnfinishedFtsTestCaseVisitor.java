...
class RelaxedUnfinishedFtsTestCaseVisitor extends RelaxedUnfinishedTestCaseVisitor {

    private static final Logger logger = LoggerFactory.getLogger(RelaxedFtsTestCaseVisitor.class);

    protected FtsMutableTestCase testCase = new FtsMutableTestCase();

    private FtsTestCaseValidator validator;

    public RelaxedUnfinishedFtsTestCaseVisitor(TestCase testCase, ExecutionNode<FeaturedTransition> executionNode, FtsTestCaseValidator validator) {
