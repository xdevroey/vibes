...
public class RelaxedFtsTestCaseVisitor extends RelaxedTestCaseVisitor {
    ...
    public RelaxedFtsTestCaseVisitor(TestCase testCase, ExecutionNode<FeaturedTransition> executionNode, FtsTestCaseValidator validator) {
